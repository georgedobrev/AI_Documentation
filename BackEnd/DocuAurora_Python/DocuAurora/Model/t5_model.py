...
def setup_pinecone(chunks, model_name, api_key, environment, index_name):
    ...
    return pineconedb.as_retriever(search_kwargs={"k": 1})
...
retriever = setup_pinecone( "hkunlp/instructor-xl", 'b4b7947c-96fd-4c95-9785-9c8ced03b64b', 'us-west1-gcp-free', "test2")
